...
I recently found the source code and image assets (created by Paul Verhulst by the way!) and decided to share this for posterity. It can still be compiled on MacOS Tahoe in 2026 using [gbdk-2020](https://github.com/gbdk-2020/gbdk-2020) and [png2gb](https://github.com/LuckyLights/png2gb)!
